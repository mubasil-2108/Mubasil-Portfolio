...
//     }
//     return (
//         <div className="relative flex justify-center items-center gap-30  px-10">
//             <div className="flex flex-col w-[35%] h-[35%] border-2 border-[#2A0E61] rounded-lg p-4 sm:p-6">
